...
const resolvers = {
    Query: {
        ...
        /* get a crew member */
        crewMember: (_, { position }, { dataSources }) => dataSources.db.getCrewMember(position),
        ...
        destination: (_, { planet }, { dataSources }) => dataSources.db.getDestination(planet),
        ...
        technology: (_, { name }, { dataSources }) => dataSources.db.getTechnology(name),
